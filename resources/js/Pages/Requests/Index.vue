                ...
                <div class="bg-white shadow-xl sm:rounded-lg">
                    <div class="my-3 p-3">
                        ...
                        <div class="my-3" v-for="request in requests">
                            <div
                                class="flex justify-between items-center p-3 border-2 shadow-md rounded-md"
                            >
                                <h1>{{ request.sender.name }}</h1>
                                <div class="flex items-center gap-2">
                                    <button
                                        @click="
                                            confirmHandler(request.sender.id)
                                        "
                                    ...
                                    <button
                                        @click="declineHandler(request.id)"
                                        class="px-6 py-2 rounded-md bg-gray-500 text-white"
                                    >
                                        Decline
                                    </button>
                                </div>
